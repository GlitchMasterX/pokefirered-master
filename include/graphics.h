...
extern const u32 gMonFrontPic_Ryujin[];
extern const u32 gMonPalette_Ryujin[];
extern const u32 gMonBackPic_Ryujin[];
extern const u32 gMonShinyPalette_Ryujin[];
extern const u8 gMonIcon_Ryujin[];
extern const u8 gMonFootprint_Ryujin[];
extern const u32 gMonFrontPic_Moltres_o[];
extern const u32 gMonPalette_Moltres_o[];
extern const u32 gMonBackPic_Moltres_o[];
extern const u32 gMonShinyPalette_Moltres_o[];
extern const u8 gMonIcon_Moltres_o[];
extern const u8 gMonFootprint_Moltres_o[];
extern const u32 gMonFrontPic_Zapdos_o[];
extern const u32 gMonPalette_Zapdos_o[];
extern const u32 gMonBackPic_Zapdos_o[];
extern const u32 gMonShinyPalette_Zapdos_o[];
extern const u8 gMonIcon_Zapdos_o[];
extern const u8 gMonFootprint_Zapdos_o[];
extern const u32 gMonFrontPic_Articuno_o[];
extern const u32 gMonPalette_Articuno_o[];
extern const u32 gMonBackPic_Articuno_o[];
extern const u32 gMonShinyPalette_Articuno_o[];
extern const u8 gMonIcon_Articuno_o[];
extern const u8 gMonFootprint_Articuno_o[];
