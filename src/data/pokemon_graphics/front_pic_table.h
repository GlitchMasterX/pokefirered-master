const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(RYUJIN, gMonFrontPic_Ryujin),
    SPECIES_SPRITE(MOLTRES_O, gMonFrontPic_Moltres_o),
    SPECIES_SPRITE(ZAPDOS_O, gMonFrontPic_Zapdos_o),
    SPECIES_SPRITE(ARTICUNO_O, gMonFrontPic_Articuno_o),
