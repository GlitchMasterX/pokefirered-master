const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(RYUJIN, gMonPalette_Ryujin),
    SPECIES_PAL(MOLTRES_O, gMonPalette_Moltres_o),
    SPECIES_PAL(ZAPDOS_O, gMonPalette_Zapdos_o),
    SPECIES_PAL(ARTICUNO_O, gMonPalette_Articuno_o),
