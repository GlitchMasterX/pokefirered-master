const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(RYUJIN, gMonShinyPalette_Ryujin),
    SPECIES_SHINY_PAL(MOLTRES_O, gMonShinyPalette_Moltres_o),
    SPECIES_SHINY_PAL(ZAPDOS_O, gMonShinyPalette_Zapdos_o),
    SPECIES_SHINY_PAL(ARTICUNO_O, gMonShinyPalette_Articuno_o),
