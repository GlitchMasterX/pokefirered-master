const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(RYUJIN, gMonBackPic_Ryujin),
    SPECIES_SPRITE(MOLTRES_O, gMonBackPic_Moltres_o),
    SPECIES_SPRITE(ZAPDOS_O, gMonBackPic_Zapdos_o),
    SPECIES_SPRITE(ARTICUNO_O, gMonBackPic_Articuno_o),
