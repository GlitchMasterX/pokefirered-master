static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_NEW_BARK_TOWN - 1] = {MAP_GROUP(NEW_BARK_TOWN), MAP_NUM(NEW_BARK_TOWN), 13, 12},
    [SPAWN_CHERRYGROVE_CITY - 1] = {MAP_GROUP(CHERRYGROVE_CITY), MAP_NUM(CHERRYGROVE_CITY), 51, 16},
    [SPAWN_VIOLET_CITY - 1] = {MAP_GROUP(VIOLET_CITY), MAP_NUM(VIOLET_CITY), 43, 31},
    [SPAWN_CIANWOOD_CITY - 1] = {MAP_GROUP(CIANWOOD_CITY), MAP_NUM(CIANWOOD_CITY), 27, 40},
    [SPAWN_OLIVINE_CITY - 1] = {MAP_GROUP(OLIVINE_CITY), MAP_NUM(OLIVINE_CITY), 15, 28},
    [SPAWN_ECRUTEAK_CITY - 1] = {MAP_GROUP(ECRUTEAK_CITY), MAP_NUM(ECRUTEAK_CITY), 29, 29},
    [SPAWN_GOLDENROD_CITY - 1] = {MAP_GROUP(GOLDENROD_CITY), MAP_NUM(GOLDENROD_CITY), 17, 30},
    [SPAWN_BLACKTHORN_CITY - 1] = {MAP_GROUP(BLACKTHORN_CITY), MAP_NUM(BLACKTHORN_CITY), 21, 30},
    [SPAWN_AZALEA_TOWN - 1] = {MAP_GROUP(AZALEA_TOWN), MAP_NUM(AZALEA_TOWN), 19, 10},
    [SPAWN_MAHOGANY_TOWN - 1] = {MAP_GROUP(MAHOGANY_TOWN), MAP_NUM(MAHOGANY_TOWN), 15, 17},
    [SPAWN_MT_SILVER - 1] = {MAP_GROUP(MT_SILVER), MAP_NUM(MT_SILVER), 28, 21},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_CIANWOOD_CITY - 1] = {MAP_GROUP(CIANWOOD_CITY), MAP_NUM(CIANWOOD_CITY)},
    [SPAWN_OLIVINE_CITY - 1] = {MAP_GROUP(OLIVINE_CITY), MAP_NUM(OLIVINE_CITY)},
    [SPAWN_ECRUTEAK_CITY - 1] = {MAP_GROUP(ECRUTEAK_CITY), MAP_NUM(ECRUTEAK_CITY)},
    [SPAWN_GOLDENROD_CITY - 1] = {MAP_GROUP(GOLDENROD_CITY), MAP_NUM(GOLDENROD_CITY)},
    [SPAWN_BLACKTHORN_CITY - 1] = {MAP_GROUP(BLACKTHORN_CITY), MAP_NUM(BLACKTHORN_CITY)},
    [SPAWN_AZALEA_TOWN - 1] = {MAP_GROUP(AZALEA_TOWN), MAP_NUM(AZALEA_TOWN)},
    [SPAWN_MAHOGANY_TOWN - 1] = {MAP_GROUP(MAHOGANY_TOWN), MAP_NUM(MAHOGANY_TOWN)},
    [SPAWN_MT_SILVER - 1] = {MAP_GROUP(MT_SILVER), MAP_NUM(MT_SILVER)},
};
...
static const u8 sWhiteoutRespawnHealerNpcIds[] =
{
    ...
    [SPAWN_CIANWOOD_CITY - 1] = 1,
    [SPAWN_OLIVINE_CITY - 1] = 1,
    [SPAWN_ECRUTEAK_CITY - 1] = 1,
    [SPAWN_GOLDENROD_CITY - 1] = 1,
    [SPAWN_BLACKTHORN_CITY - 1] = 1,
    [SPAWN_AZALEA_TOWN - 1] = 1,
    [SPAWN_MAHOGANY_TOWN - 1] = 1,
    [SPAWN_MT_SILVER - 1] = 1,
};
