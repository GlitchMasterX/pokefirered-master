...
const struct SpriteTemplate gFieldEffectObjectTemplate_ShadowSmall =
{
    .tileTag = TAG_NONE,
    //.paletteTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_PLAYER_RED,  //Dynamic OverWorld Pals
...
const struct SpriteTemplate gFieldEffectObjectTemplate_Sparkle = {
    .tileTag = 0xFFFF,
    //.paletteTag = 0xFFFF,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_PINK, //Dynamic OverWorld Pals
    .oam = &gObjectEventBaseOam_16x16,
...
const struct SpriteTemplate gFieldEffectObjectTemplate_TreeDisguise =
{
    .tileTag = TAG_NONE,
    //.paletteTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_GREEN, //Dynamic OverWorld Pals
...
const struct SpriteTemplate gFieldEffectObjectTemplate_SandDisguisePlaceholder =
{
    .tileTag = TAG_NONE,
    //.paletteTag = TAG_NONE,
    .paletteTag = OBJ_EVENT_PAL_TAG_NPC_BLUE, //Dynamic OverWorld Pals
    .oam = &gObjectEventBaseOam_16x32,
    .anims = sAnimTable_TreeDisguise,
