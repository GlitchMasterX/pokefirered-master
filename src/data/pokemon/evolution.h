const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_KADABRA]    = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_ALAKAZAM}},
    [SPECIES_MACHOP]     = {{EVO_LEVEL, 28, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]    = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_GOLEM}},
    ...
    [SPECIES_PORYGON]    = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_PORYGON2}},
    ...
    [SPECIES_PICHU]      = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_PIKACHU}},
    [SPECIES_CLEFFA]     = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_CLEFAIRY}},
    [SPECIES_IGGLYBUFF]  = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_JIGGLYPUFF}},
    [SPECIES_TOGEPI]     = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_TOGETIC}},
    ...
    [SPECIES_AZURILL]    = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_MARILL}},
