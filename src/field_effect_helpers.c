...
//static void LoadObjectRegularReflectionPalette(struct ObjectEvent * objectEvent, u8 paletteNum); //Dynamic Overworld Pal
...
//static u32 ShowDisguiseFieldEffect(u8 fldEff, u8 templateIdx, u8 paletteNum);//Dynamic Overworld Pal
...
void SetUpReflection(struct ObjectEvent * objectEvent, struct Sprite *sprite, bool8 stillReflection)
{
    ...
    //reflectionSprite->oam.paletteNum = gReflectionEffectPaletteMap[reflectionSprite->oam.paletteNum]; //Dynamic Overworld Pal
...
#define OBJ_EVENT_PAL_TAG_BRIDGE_REFLECTION 0x1102 //Dynamic Overworld Pal
...
static void LoadObjectReflectionPalette(struct ObjectEvent * objectEvent, struct Sprite *sprite)
{
    ...
    if (!GetObjectEventGraphicsInfo(objectEvent->graphicsId)->disableReflectionPaletteLoad && ((bridgeType = MetatileBehavior_GetBridgeType(objectEvent->previousMetatileBehavior)) || (bridgeType = MetatileBehavior_GetBridgeType(objectEvent->currentMetatileBehavior))))
    {
        ...
        //LoadObjectHighBridgeReflectionPalette(objectEvent, sprite->oam.paletteNum); //Dynamic Overworld Pal
    ...
    {
        //LoadObjectRegularReflectionPalette(objectEvent, sprite->oam.paletteNum); //Dynamic Overworld Pal
...
static void UpdateObjectReflectionSprite(struct Sprite *reflectionSprite)
{
    ...
    {
        //reflectionSprite->oam.paletteNum = gReflectionEffectPaletteMap[mainSprite->oam.paletteNum]; //Dynamic Overworld Pal
...
u8 CreateWarpArrowSprite(void)
{
    ...
    LoadFieldEffectPalette_(FLDEFFOBJ_ARROW, FALSE); //Dynamic Overworld Pal
...
u32 FldEff_Shadow(void)
{
    ...
    LoadFieldEffectPalette_(gShadowEffectTemplateIds[graphicsInfo->shadowSize], FALSE); //Dynamic Overworld Pals
...
u32 FldEff_JumpLongGrass(void)
{
    ...
    LoadFieldEffectPalette(FLDEFFOBJ_SURF_BLOB); //Dynamic OverWorld Palettes
...
u32 FldEff_SurfBlob(void)
{
    ...
    if (spriteId != MAX_SPRITES)
    {
        sprite = &gSprites[spriteId];
        sprite->coordOffsetEnabled = TRUE;
        //sprite->oam.paletteNum = 0; //Dynamic Overworld Pal
...
//static u32 ShowDisguiseFieldEffect(u8 fldEff, u8 templateIdx, u8 paletteNum) //Dynamic OverWorld Pals
static u32 ShowDisguiseFieldEffect(u8 fldEff, u8 templateIdx)
{
    ...
    LoadFieldEffectPalette(templateIdx); //Dynamic OverWorld Pals
