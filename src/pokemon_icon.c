...
const u8 *const gMonIconTable[] = {
    ...
    [SPECIES_RYUJIN]      = gMonIcon_Ryujin,
    [SPECIES_MOLTRES_O]   = gMonIcon_Moltres_o,
    [SPECIES_ZAPDOS_O]    = gMonIcon_Zapdos_o,
    [SPECIES_ARTICUNO_O]  = gMonIcon_Articuno_o,
